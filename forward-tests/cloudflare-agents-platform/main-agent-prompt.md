...
- Candidate Prompt: web-article-capture/forward-tests/cloudflare-agents-platform/candidate/prompt.md
- Candidate Input: web-article-capture/forward-tests/cloudflare-agents-platform/candidate/input/
- Output: .tmp/forward-tests/web-article-capture/cloudflare-agents-platform/<run-id>/
