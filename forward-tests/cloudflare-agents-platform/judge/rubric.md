...
- Content Selection: captures article/main正文 from Cloudflare Agents documentation, excluding page chrome.
...
- Source Notes: records concise capture notes inside `source.md` when source boundaries, missing media, Markdown variants, or reliability details matter.
