...
- Content Selection: captures article/main正文 from Alibaba Cloud technical sources and documentation, excluding page chrome.
...
- Source Notes: records concise capture notes inside `source.md` when source boundaries, missing media, language variants, or reliability details matter.
