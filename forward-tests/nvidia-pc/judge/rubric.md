...
- Content Selection: captures article/main正文, excluding navigation, footer, recommendations, ads, social buttons, tracking pixels, and unrelated page chrome.
...
- Source Notes: records concise capture notes inside `source.md` when source boundaries, missing media, or reliability details matter.
