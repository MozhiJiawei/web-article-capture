...
- Candidate Prompt: web-article-capture/forward-tests/nvidia-dynamo-disaggregated-serving/candidate/prompt.md
- Candidate Input: web-article-capture/forward-tests/nvidia-dynamo-disaggregated-serving/candidate/input/
- Output: .tmp/forward-tests/web-article-capture/nvidia-dynamo-disaggregated-serving/<run-id>/
